...
class Payment(Base, RestaurantMixin):
    ...
    provider = Column(Text, nullable=False, default="RAZORPAY")  # RAZORPAY
    status = Column(Text, nullable=False, default="CREATED")  # CREATED|AUTHORIZED|CAPTURED|FAILED|REFUNDED
